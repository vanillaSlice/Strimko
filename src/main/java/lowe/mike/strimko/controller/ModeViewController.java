...
public abstract class ModeViewController {
	 ...
	 * 
	 * @param task
	 *            the {@link Task} to add the handler to
	 */
	 ...
	 * 
	 * @param node
	 *            the {@link Node} to add the style to
	 * @param streamIndex
	 *            the stream index
	 */
	 ...
	 * 
	 * @param node
	 *            the {@link Node} to remove the style class from
	 * @param streamIndex
	 *            the stream index
	 */
	 ...
	 * 
	 * @param cellPane
	 *            the cell pane to add the number {@link Label} to
	 * @param textProperty
	 *            the {@link ObservableStringValue} text property
	 * @param visibilityProperty
	 *            the {@link ObservableBooleanValue} visibility property
	 */
	 ...
	 * 
	 * @param cellPane
	 *            the cell pane to add the solution {@link Label} to
	 * @param number
	 *            the solution number
	 * @param visibilityProperty
	 *            the {@link ObservableBooleanValue} visibility property
	 ...
	 * 
	 * @param cellPane
	 *            the cell pane to remove the solution {@link Label} from
	 */
	...
	/**
	 * @param button
	 *            the {@link ToggleButton} to get the number from
