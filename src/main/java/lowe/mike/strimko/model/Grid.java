...
public final class Grid {
	...
	private void updateNumberOccurrences(int oldNumber, int newNumber) {
		...
		ReadOnlyIntegerWrapper newNumberOccurence = numberOccurrences.get(newNumber);
		oldNumberOccurrence.set(oldNumberOccurrence.get() - 1);
		newNumberOccurence.set(newNumberOccurence.get() + 1);
	}
	...
	/**
	 * @param rowIndex
	 *            row index of the {@link Cell}
	 * @param columnIndex
	 *            column index of the {@link Cell}
	...
	/**
	 * @param position
	 *            the {@link Position} of the {@link Cell}
	...
	/**
	 * @return the {@link Collection} of all {@link Cells}
	 */
	...
	/**
	 * @param rowIndex
	 *            row index to get {@link Cell}s from
	...
	/**
	 * @param columnIndex
	 *            column index to get {@link Cell}s from
	 * @return the {@link Collection} of {@link Cell}s with the given
	 *         {@code columnIndex}
	 */
	...
	/**
	 * @param streamIndex
	 *            stream index to get {@link Cell}s from
	 * @return the {@link Collection} of {@link Cell}s with the given
	 *         {@code streamIndex}
	 */
	...
	/**
	 * @param number
	 *            the number to get occurrences for
	...
	/**
	 * @param number
	 *            the number to return the property for
	...
	public static final class GridBuilder {
		 ...
		 * 
		 * @param size
		 *            the size of the {@link Grid} to create
		 * @throws IllegalArgumentException
		 *             if the size passed in is invalid
		 */
		 ...
		 * @throws IllegalArgumentException
		 *             if the stream index is invalid
		 */
		 ...
		 * @return this {@code GridBuilder}
		 * @throws IllegalArgumentException
		 *             if {@code streams} contains an invalid stream index
		 */
		 ...
		 * @return this {@code GridBuilder}
		 * @throws IllegalArgumentException
		 *             if {@code numbers} contains an invalid number
		 */
		...
		/**
		 * @param streamIndex
		 *            the streamIndex to get occurrences for
		...
		/**
		 * @param streamIndex
		 *            the streamIndex to return the property for
		 * @return the {@link ReadOnlyIntegerProperty} indicating the number of
		 ...
		 * @throws IllegalArgumentException
		 *             if the array of stream indexes is invalid or if any row,
		...
		public boolean equals(Object obj) {
			...
			if (!deepEquals(streams, other.streams))
				return false;
			if (!deepEquals(numbers, other.numbers))
				return false;
			return true;
		}
