...
final class Validation {
	 ...
	 * 
	 * @param streams
	 *            the array of stream indexes
	 * @throws IllegalArgumentException
	 *             if the array of stream indexes does not meet the desired
	 *             conditions
	 */
	 ...
	 * 
	 * @param grid
	 *            the {@link Grid} to check
	 * @throws IllegalArgumentException
	 *             if any row, column or stream does not contain unique numbers
	 */
