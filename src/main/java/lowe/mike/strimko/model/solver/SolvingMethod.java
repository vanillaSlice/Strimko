...
/**
 * {@code SolvingMethod} represents a solving method that subclasses define the
...
class SolvingMethod {
	...
	/**
	 * @param cell
	 *            the {@link Cell} to check
	 * @param number
	 *            the number to check is in the possible numbers
	 * @return {@code true} if the {@link Cell} contains the number in its
	 *         possible candidate numbers
	 */
	...
	/**
	 * @param group
	 *            the group of {@link Cell}s to get the subset from
	 * @param number
	 *            the number to check the {@link Cell}s for
	 * @return a {@link Collection} of {@link Cell}s containing the number in
	 *         its possible candidate numbers
	 */
