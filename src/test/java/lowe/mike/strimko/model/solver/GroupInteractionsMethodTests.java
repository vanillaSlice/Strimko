...
import static lowe.mike.strimko.model.solver.GroupInteractionsMethod.*;
...
public final class GroupInteractionsMethodTests extends SolvingMethodTests {
    ...
    public void test_runPointingNOverRows() {
        // setup
        int[][] numbers = {{0, 3, 0, 7, 8, 1, 0, 5, 0}, {7, 0, 0, 2, 3, 9, 6, 8, 0}, {0, 0, 0, 6, 5, 4, 0, 7, 3},
    ...
    public void test_runPointingNOverColumns() {
        // setup
        int[][] numbers = {{9, 3, 0, 0, 5, 0, 0, 0, 0}, {2, 0, 0, 6, 3, 0, 0, 9, 5}, {8, 5, 6, 0, 0, 2, 0, 0, 0},
    ...
    public void test_runStreamLineReductionNOverRows() {
        // setup
        int[][] numbers = {{0, 1, 6, 0, 0, 7, 8, 0, 3}, {0, 9, 0, 8, 0, 0, 0, 0, 0}, {8, 7, 0, 0, 0, 1, 0, 6, 0},
                {0, 4, 8, 0, 0, 0, 3, 0, 0}, {6, 5, 0, 0, 0, 9, 0, 8, 2}, {2, 3, 9, 0, 0, 0, 6, 5, 0},
                {0, 6, 0, 9, 0, 0, 0, 2, 0}, {0, 8, 0, 0, 0, 2, 9, 3, 6}, {9, 2, 4, 6, 0, 0, 5, 1, 0}};
        Grid grid = newSudokuGrid(numbers);

        // execution
        boolean changed = runStreamLineReductionNOverRows(grid, 2);
    ...
    public void test_runStreamLineReductionNOverColumns() {
        ...
        // execution
        boolean changed = runStreamLineReductionNOverColumns(grid, 2);
